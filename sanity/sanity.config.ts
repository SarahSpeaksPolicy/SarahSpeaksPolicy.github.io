...
import { about, category, policyWork, policyAndWorkPage, contact, marginalia } from './schemas/index';
...
export default defineConfig({
  ...
  schema: {
    types: [hero, about, category, policyWork, policyAndWorkPage, contact, marginalia],
  },
});
